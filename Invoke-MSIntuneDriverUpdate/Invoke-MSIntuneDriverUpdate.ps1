...
.NOTES
    ...
    1.0.3 - (2020-08-19) Added Additional Windows 10 Builds. Linting.
#>

# // =================== GLOBAL VARIABLES ====================== //

$TempLocation = Join-Path $env:SystemDrive '~Intune'
